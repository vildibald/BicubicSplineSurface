...
Spline FullAlgorithm::Calculate(KnotVector xVector,
        KnotVector yVector)
{
...
void FullAlgorithm::FillDx(Spline& spline)
{
    ...
    FillD(spline.ColumnsCount(), spline.RowsCount(), xTridiagonals_, differenceGetter,
            parameterGetter,
...
void FullAlgorithm::FillDy(Spline& spline)
{
    ...
    FillD(spline.RowsCount(), spline.ColumnsCount(), yTridiagonals_, differenceGetter,
            parameterGetter,
            derivationGetter, derivationSetter);
}
